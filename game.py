...
class GameUI(BoxLayout):
    ...
    def _init_ui(self):
        ...
        self.output_label.bind(width=lambda instance, width: setattr(instance, 'text_size', (width, None)))
        self.output_label.bind(texture_size=self._on_texture_size)
...
class RedAffairApp(App):
    ...
    music_info = {
        ...
        'audio/track3.ogg': ('Idle Stupor', 'Dotdropper'),
